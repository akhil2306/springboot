...
VALUES
  ('Akhil', 'B', 'akhil.b@example.com', '1234567890'),
  ('karthik', 'S', 'karthik.s@example.com', '9876543210'),
  ('tharun', 'B', 'tharun.b@example.com', '5555555555'),
  ('arun', 'D', 'arun.d@example.com', '1111111111'),
  ('nithin', 'A', 'nithin.a@example.com', '9999999999');
